...
Try [Nexty.dev today](https://nexty.dev?utm_source=github-test-azure-004)
---
...
- [👉 Source Code](https://github.com/weijunext/test-azure-004)
...
```bash
git clone https://github.com/weijunext/test-azure-004.git
cd test-azure-004
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/weijunext/test-azure-004&project-name=&repository-name=test-azure-004&demo-title=NextjsStarter&demo-description=Nextjs%2015%20starter.&demo-url=https://nextforge.dev&demo-image=https://nextforge.dev/og.png)
